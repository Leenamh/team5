...
//                    
            ...
            .onAppear {
                       ...
                       selectedOption = 3
                       dragValue = 3
                   }.navigationBarBackButtonHidden(true) // 👈 hides the default blue back button
    ...
    func getCurrentText() -> String {
        ...
        case 0: return "1-How satisfied are you with:\n \(detail.pros)?" //+ " 1"
        case 1: return "2-How satisfied are you with:\n \(detail.cons)?"
        case 2: return "3-How satisfied are you with:\n \(detail.offer)?"
        case 3: return "4-How satisfied are you with:\n \(detail.demand)?"
        case 4: return "4-How satisfied are you with:\n \(detail.in5Months)?"
        case 5: return "6-How satisfied are you with:\n \(detail.in5Years)?"
        default: return ""
        }
    }
